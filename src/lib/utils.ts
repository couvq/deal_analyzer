...
Determine the Principal (P): Subtract your down payment amount from the home's purchase price to find the actual loan amount.
Calculate Monthly Interest Rate (i): Divide the annual interest rate (as a decimal) by 12. (e.g., 6% annual rate becomes 0.06 / 12 = 0.005).
Calculate Number of Payments (n): Multiply the loan term in years by 12. (e.g., a 30-year loan is 30 * 12 = 360 payments).
Apply the Formula: Plug your P, i, and n into the mortgage formula:
M = P [ i(1 + i)^n ] / [ (1 + i)^n – 1]
